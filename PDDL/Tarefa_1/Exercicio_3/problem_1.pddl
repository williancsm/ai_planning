...
(define (problem P_Frota_Uber_Autonomo_1)
 (:domain D_Frota_Uber_Autonomo_3)
 
 (:objects 
    Carro_1 Carro_2 Carro_3 Carro_4 - Carro
    Ponto_A Ponto_B Ponto_C Ponto_D Ponto_E - Local
    Passageiro_1 Passageiro_2 Passageiro_3 Passageiro_4 Passageiro_5 Passageiro_6 Passageiro_7 Passageiro_8 Passageiro_9 Passageiro_10 - Passageiro
 )
 ...
 (:init
    ...
    (Esta       Passageiro_6    Ponto_E)
    (Esta       Passageiro_7    Ponto_A)
    (Esta       Passageiro_8    Ponto_D)
    (Esta       Passageiro_9    Ponto_A)
    (Esta       Passageiro_10   Ponto_D)
    ...
    (Aguardando Passageiro_6    Ponto_B)
    (Aguardando Passageiro_7    Ponto_D)
    (Aguardando Passageiro_8    Ponto_E)
    (Aguardando Passageiro_9    Ponto_B)
    (Aguardando Passageiro_10   Ponto_C)
...
(:goal (and (Esta       Passageiro_1    Ponto_E)
            ...
            (Esta       Passageiro_6    Ponto_B)
            (Esta       Passageiro_7    Ponto_D)
            (Esta       Passageiro_8    Ponto_E)
            (Esta       Passageiro_9    Ponto_B)
            (Esta       Passageiro_10   Ponto_C)
            (Esta       Carro_1         Ponto_A)
            (Esta       Carro_2         Ponto_A)
            (Esta       Carro_3         Ponto_A)
            (Esta       Carro_4         Ponto_A)

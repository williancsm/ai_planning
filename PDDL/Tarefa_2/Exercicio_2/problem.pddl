...
(define (problem P_Missoes_Drone_2)
 ...
 (:init
    ...
    ;(Planejada  Aspergir_Inseticida Regiao_6)
    ;(Planejada  Tirar_Fotos Regiao_6)
    ;(Planejada  Aspergir_Inseticida Regiao_7)
    ;(Planejada  Tirar_Fotos Regiao_7)
    ...
    ; R6 - B3
    ;(= (Distancia_Mapa Regiao_6 Base_3) 70.0)
    ;(= (Distancia_Mapa Base_3 Regiao_6) 70.0)
    ;
    ; B1 - B2
 ...
 (:goal (and (Esta       Drone_1 Base_1)
             ...
             ;(Concluida  Aspergir_Inseticida Regiao_6)
             ;(Concluida  Tirar_Fotos Regiao_6)
             ;(Concluida  Aspergir_Inseticida Regiao_7)
             ;(Concluida  Tirar_Fotos Regiao_7)
        )
 )
